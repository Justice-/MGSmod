...
stuck, possibly pulling the weapon from your hands, but the monster with \n\
stuck weapon would move more slowly. A miss may make you stumble and lose\n\
...
\n\
 ...
 comestibles may be eaten with 'E', leaving you with an empty container.\n\
\n\
\n\
\n\
...
( Firearm\n\
 ...
 fired with 'f'. Some have automatic fire, which may be used with 'F'. Each\n\
 has accuracy rating, bonus to damage, rate of fire, and maximum load. Most\n\
 firearms load fully in one action, while shotguns only one shell at a time.\n\
\n\
= Ammunition\n\
...
rarely destroyed. Crossbows suffer from a short range and a very long\n\
...
A: Run Mode is a way to guarantee you won't die by holding a movement\n\
   key down. When a monster comes into view, your move will be ignored\n\
   until Run Mode is turned off with the ! key.\n\
\n\
Q: It seems like everything I eat makes me sick! What's wrong?\n\
A: Lots of the food is perishable and will only last a few days After\n\
   first couple of days switch to canned food, jerky, and hunting.\n\
\n\
Q: Why doesn't reading a book seem to give me any training?\n\
A: Your skills will not be displayed in @ screen until they reach level\n\
...
A: You'll need a hammer, nails, and two by fours. Use the hammer and\n\
   choose the direction in which the terrain you wish to barricade lies.\n\
\n\
