...
void game::print_menu(WINDOW* w_open, int iSel, const int iMenuOffsetX, int iMenuOffsetY, bool bShowDDA)
{
    ...
    mvwprintz(w_open, 23, 4, c_ltblue, "Cataclysm: Metal Gear Solid (rev.49) *** Forum: www.cataclysmdda.com/smf");
...
//CAT-mgs: enable for Old Snake
sel2= 2;
layer= 3;

//CAT-mgs: disable for Old Snake
//   input = get_input();
