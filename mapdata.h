...
{"open window",      '\'', c_ltcyan, 5, tr_null,
...
{"empty window",     '0', c_yellow,  7, tr_null,
	mfb(transparent)|mfb(flammable)|mfb(supports_roof)},
{"window frame",     '0', c_ltcyan,  7, tr_null,
...
{"tree trunk",              '1', c_brown,   5, tr_null,
...
{"wax floor",        '.', c_yellow,  3, tr_null,
	mfb(transparent)|mfb(l_flammable)},
{"picket fence",     '|', c_brown,   5, tr_null,
...
{"slide",            '#', c_ltcyan,  7, tr_null,
	mfb(transparent)|mfb(deconstruct)},
{"monkey bars",      '#', c_cyan,    5, tr_null,
	mfb(transparent)|mfb(deconstruct)},
{"backboard",        '7', c_red,     0, tr_null,
	mfb(transparent)|mfb(deconstruct)},
{"bench",            '#', c_brown,   5, tr_null,
	mfb(transparent)|mfb(flammable2)|mfb(collapses)|mfb(deconstruct)},
{"table",            '#', c_red,     5, tr_null,
	mfb(transparent)|mfb(flammable)|mfb(collapses)|mfb(deconstruct)},
{"pool table",       '#', c_green,   7, tr_null,
	mfb(transparent)|mfb(flammable)|mfb(collapses)|mfb(deconstruct)},
...
{"ladder",           '>', c_dkgray,  2, tr_null,
        mfb(transparent)|mfb(goes_down)|mfb(place_item)},
{"slope",   '>', c_brown,   2, tr_null,
        mfb(transparent)|mfb(goes_down)|mfb(place_item)},
{"slope",     '<', c_brown,   2, tr_null,
        mfb(transparent)|mfb(goes_up)|mfb(place_item)},
{"rope",  '<', c_white,   2, tr_null,
...
//CAT-mgs:
{"thin air",      '.', i_ltcyan,		1, tr_airhole,
	mfb(transparent)|mfb(noitem)},
{"indoor hole",      ' ', c_black,		1,  tr_ledge,
	mfb(transparent)|mfb(noitem)},
{"church bell",      '#', c_yellow,		3, tr_null,
	mfb(supports_roof)},
