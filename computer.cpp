...
//CAT-mgs: spawn nuclear reactor, plasma engine, plutonium, plasma fuel, mininukes
	g->m.add_item(g->u.posx+12+rng(-2,2), g->u.posy+9+rng(-2,2), g->itypes[itm_plut_cell], 0);
	g->m.add_item(g->u.posx+12+rng(-2,2), g->u.posy+9+rng(-2,2), g->itypes[itm_plasma], 0);
	g->m.add_item(g->u.posx+12+rng(-2,2), g->u.posy+9+rng(-2,2), g->itypes[itm_mininuke], 0);
